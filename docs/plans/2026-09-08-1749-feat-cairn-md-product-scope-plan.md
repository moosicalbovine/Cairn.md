...
> File paths and terminology were corrected after release where the original references no longer matched the repository; the product decisions remain unchanged.
